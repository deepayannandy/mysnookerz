  ...
  return (
    ...
    >
      ...
      >
        ...
        <MenuItem href={`/${locale}/dashboards/store`}>{dictionary['navigation'].store}</MenuItem>
        ...
        <MenuItem href={`/${locale}/subscription`}>{dictionary['navigation'].subscription}</MenuItem>
